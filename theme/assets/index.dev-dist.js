...
/* harmony import */ var _Index_bs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _Index_bs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_Index_bs__WEBPACK_IMPORTED_MODULE_0__);
...
var ReactDOMRe = __webpack_require__(19);

function Index$TestComponent(Props) {
  return "React TestComponent";
}

var TestComponent = {
  make: Index$TestComponent
};
var mounts = [{
  id: "react-mount-app",
  node: React.createElement(Index$TestComponent, {})
}];
var elementsById = $$Array.map(function (mount) {
  var el = document.getElementById(mount.id);

  if (el == null) {
    return null;
  } else {
    return ReactDom.createPortal(mount.node, el);
  }
}, mounts);
ReactDOMRe.renderToElementWithId(React.createElement("div", undefined, elementsById), "react-mount-main");
exports.TestComponent = TestComponent;
exports.mounts = mounts;
exports.elementsById = elementsById;
...
var Caml_js_exceptions = __webpack_require__(8);
...
var Caml_option = __webpack_require__(9);
...
if (true) {
  (function () {
    ...
    var _assign = __webpack_require__(12); // TODO: this is special because it gets imported during build.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */if(true){(function(){'use strict';var React=__webpack_require__(10);var _assign=__webpack_require__(12);var Scheduler=__webpack_require__(15);var tracing=__webpack_require__(17);var ReactSharedInternals=React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;// by calls to these methods by a Babel plugin.
//
// In PROD (or in packages without access to React internals),
// they are left as they are instead.
